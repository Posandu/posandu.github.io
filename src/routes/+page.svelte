...
<div class="grid gap-8 md:grid-cols-3 grid-cols-1 mb-4">
	...
	>
		<p>
			...
			<span class="font-semibold text-blue-400">web development</span>, although
			I also engage in
			<span class="font-semibold text-green-400">software development</span>,
			<span class="font-semibold text-indigo-400">machine learning</span>, and
			<span class="font-semibold text-green-400">cryptocurrency</span>
		...
		<p class="my-2">
			I possess experience in creating enterprise software and hold a
			certification from
			<a
