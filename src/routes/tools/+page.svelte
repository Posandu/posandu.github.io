<svelte:head>
	<title>Posandu Mapa - Tools</title>
</svelte:head>

<div
	class="flex bg-base-300 text-gray-500 hover:bg-base-300/90 transition-all mt-4 rounded-lg text-sm p-4"
>
...
>
	...
	<div class="flex-1 text-white">
		PowerShell, Windows Terminal, Zoxide, terminai, starship, ni, pnpm
	</div>
</div>
